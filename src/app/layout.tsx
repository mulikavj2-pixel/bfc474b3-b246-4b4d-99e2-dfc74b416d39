...
export const metadata: Metadata = {
  ...
  description: "Discover handcrafted, fair-trade specialty coffee at Brew Haven. Expert baristas, sustainably sourced beans, and a welcoming community space.",
  keywords: "specialty coffee, fair trade coffee, coffee shop, artisan roasted, espresso, latte art, barista",
  metadataBase: new URL("https://brewhaven.com"),
  alternates: {
    canonical: "https://brewhaven.com"
  },
  openGraph: {
    title: "Brew Haven - Your Perfect Cup of Coffee",
    description: "Experience handcrafted specialty coffee with ethically sourced beans and expert baristas",
    url: "https://brewhaven.com",
    siteName: "Brew Haven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765879481038-4l9z0brj.jpg",
  ...
  twitter: {
    ...
    description: "Handcrafted coffee from ethically sourced, fair-trade beans",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765879481038-4l9z0brj.jpg"]
  },
  robots: {
    index: true,
    follow: true
